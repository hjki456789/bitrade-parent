...
@Entity
@Table
public class DepositRecommendProfitInfo {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof DepositRecommendProfitInfo)) {
            return false;
        }
        final DepositRecommendProfitInfo other = (DepositRecommendProfitInfo) o;
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof DepositRecommendProfitInfo;
    }
    ...
    public String toString() {
        return "DepositRecommendProfitInfo(id=" + this.getId() + ", memberId=" + this.getMemberId() + ", fromMemberId=" + this.getFromMemberId() + ", coinName=" + this.getCoinName() + ", depositId=" + this.getDepositId() + ", amount=" + this.getAmount() + ", fundAmount=" + this.getFundAmount() + ", depositAmount=" + this.getDepositAmount() + ", sequence=" + this.getSequence() + ", time=" + this.getTime() + ", username=" + this.getUsername() + ", mobilePhone=" + this.getMobilePhone() + ", email=" + this.getEmail() + ")";
    }
}
