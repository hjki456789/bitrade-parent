...
public class DepositWallet {
    ...
    private BigDecimal totalInBalance;
    @Transient
    ...
    public DepositWallet() {
        ...
        this.totalInBalance = BigDecimal.ZERO;
    }
    ...
    public BigDecimal getTotalInBalance() {
    ...
    public void setTotalInBalance(final BigDecimal totalInBalance) {
    ...
    public boolean equals(final Object o) {
        ...
        if (!(o instanceof DepositWallet)) {
            return false;
        }
        final DepositWallet other = (DepositWallet) o;
        ...
        final Object this$totalInBalance = this.getTotalInBalance();
        final Object other$totalInBalance = other.getTotalInBalance();
        Label_0300:
        {
            if (this$totalInBalance == null) {
                if (other$totalInBalance == null) {
                    break Label_0300;
                }
            } else if (this$totalInBalance.equals(other$totalInBalance)) {
                break Label_0300;
            }
            return false;
        }
    ...
    protected boolean canEqual(final Object other) {
        return other instanceof DepositWallet;
    }
    ...
    public int hashCode() {
        ...
        final Object $totalInBalance = this.getTotalInBalance();
        result = result * 59 + (($totalInBalance == null) ? 43 : $totalInBalance.hashCode());
    ...
    public String toString() {
        return "DepositWallet(id=" + this.getId() + ", memberId=" + this.getMemberId() + ", coin=" + this.getCoin() + ", balance=" + this.getBalance() + ", frozenBalance=" + this.getFrozenBalance() + ", version=" + this.getVersion() + ", isLock=" + this.getIsLock() + ", totalInBalance=" + this.getTotalInBalance() + ", username=" + this.getUsername() + ", mobilePhone=" + this.getMobilePhone() + ", realName=" + this.getRealName() + ", email=" + this.getEmail() + ")";
    }
}
