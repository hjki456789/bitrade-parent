    ...
    public static TransactionType valueOfOrdinal(int ordinal) {
        switch (ordinal) {
            ...
            case 12:
                return DEPOSIT;
            case 13:
                return GET_BACK_DEPOSIT;
            case 14:
                return LEGAL_RECHARGE;
            case 15:
                return ASSET_EXCHANGE;
            case 16:
                return CHANNEL_AWARD;
            case 17:
                return TRANSFER_INTO_LEVER;
            case 18:
                return TRANSFER_OUT_LEVER;
            case 19:
                return MANUAL_AIRDROP;
            case 20:
