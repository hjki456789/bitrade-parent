...
public class MarginBorrowOrderDto {
    ...
    public String toString() {
        return "MarginBorrowOrderDto{borrow_id=" + this.borrow_id + ", instrument_id='" + this.instrument_id + '\'' + ", currency='" + this.currency + '\'' + ", timestamp='" + this.timestamp + '\'' + ", amount='" + this.amount + '\'' + ", interest='" + this.interest + '\'' + ", returned_amount='" + this.returned_amount + '\'' + ", paid_interest='" + this.paid_interest + '\'' + ", last_interest_time='" + this.last_interest_time + '\'' + ", force_repay_time='" + this.force_repay_time + '\'' + ", rate='" + this.rate + '\'' + '}';
    }

    public String getForce_repay_time() {
        return this.force_repay_time;
    }

    public void setForce_repay_time(final String force_repay_time) {
