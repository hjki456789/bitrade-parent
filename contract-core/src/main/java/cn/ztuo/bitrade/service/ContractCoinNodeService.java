...
public class ContractCoinNodeService
{
    ...
    public ContractCoinNode findOne(final String id) {
        return (ContractCoinNode)this.contractCoinNodeRepository.findOne((Serializable)id);
    }
    ...
    public ContractCoinNode insert(final String coinId, final String nodeId) {
        ...
        return (ContractCoinNode)this.contractCoinNodeRepository.save((Object)contractCoinNode);
    }
    ...
    public void deleteByIds(final String[] ids) {
        for (final String id : ids) {
            this.contractCoinNodeRepository.delete((Serializable)id);
        }
    }
}
