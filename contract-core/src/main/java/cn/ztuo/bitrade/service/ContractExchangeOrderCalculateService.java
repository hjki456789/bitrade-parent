...
public class ContractExchangeOrderCalculateService
{
    ...
    public ContractExchangeOrderCalculate findByOrderId(final Long orderId) {
        return (ContractExchangeOrderCalculate)this.contractExchangeOrderCalculateRepository.findOne((Serializable)orderId);
    }
    
    public ContractExchangeOrderCalculate save(final ContractExchangeOrderCalculate calculate) {
        return (ContractExchangeOrderCalculate)this.contractExchangeOrderCalculateRepository.saveAndFlush((Object)calculate);
    }
